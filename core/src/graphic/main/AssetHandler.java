...
public class AssetHandler {
    ...
    private static void loadCardAssets() {
    ...
    private static void loadBattleAsset() {
    ...
    private static void loadSlotAssets() {
    ...
    private static void loadBackground() {
        ...
        assetManager.load("backGround/auction background.png", Texture.class);
    }
